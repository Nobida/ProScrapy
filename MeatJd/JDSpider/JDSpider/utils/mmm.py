...
def get_data(url):
    #加载上面的加密js
    fun1 = execjs.compile(funJs)
    token = fun1.call('d.encrypt', url, 2, 1)
    # print(token)
    ...
    page = requests.get("http://tool.manmanbuy.com/history.aspx", headers=headers, params=data)
    return json.loads(page.text)



#if __name__ == '__main__':
#    #慢慢买对输入的url有处理，淘宝和天猫的复制出来很长但是需要的却只是如下格式
#    url="https://item.jd.com/10540529205.html"
#    html = json.loads((get_data(url)))
#    #print(html)
#    print(eval('['+html['datePrice']+']'))
